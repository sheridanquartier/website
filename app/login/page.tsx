...
export default function LoginPage() {
  ...
  return (
    <>
      <div className="app-screen px-4 pt-[calc(5rem+env(safe-area-inset-top))] md:hidden">
        <div className="mx-auto max-w-[28rem]">
          <div className="mb-7 flex h-14 w-14 items-center justify-center rounded-[16px] bg-[var(--app-ios-accent)] text-white shadow-[0_2px_8px_rgba(15,49,39,0.14)]">
          ...
          <form onSubmit={handleSubmit}>
            <label htmlFor="mobile-password" className="mb-2 block text-[12px] font-medium text-[var(--app-ios-muted)]">
              Passwort
            </label>
            <input
              id="mobile-password"
              ...
              className="input min-h-[56px] text-[17px]"
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 flex min-h-[54px] w-full items-center justify-center rounded-[14px] bg-[var(--app-ios-accent)] text-[15px] font-semibold text-white shadow-[0_1px_2px_rgba(15,49,39,0.08)] disabled:opacity-60"
            >
              {loading ? 'Wird geprüft...' : 'Mein Quartier öffnen'}
            </button>
          </form>

          <div className="mt-7 flex items-start gap-3 rounded-[18px] bg-[var(--app-ios-accent-soft)] p-4">
            <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white text-[12px] font-semibold text-[var(--app-ios-accent)]">?</span>
